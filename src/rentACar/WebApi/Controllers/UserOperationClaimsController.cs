...
public class UserOperationClaimsController : BaseController
{
    ...
    {
        GetByIdUserOperationClaimResponse result =
            await Mediator.Send(getByIdUserOperationClaimQuery);
        return Ok(result);
    }
    ...
    public async Task<IActionResult> GetList([FromQuery] PageRequest pageRequest)
    {
        ...
        GetListResponse<GetListUserOperationClaimListResponseDto> result =
    ...
    {
        CreatedUserOperationClaimResponse result =
    ...
    {
        UpdatedUserOperationClaimResponse result =
    ...
    {
        DeletedUserOperationClaimResponse result =
