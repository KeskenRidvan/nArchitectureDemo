...
public class OperationClaimsController : BaseController
{
    ...
    public async Task<IActionResult> GetList([FromQuery] PageRequest pageRequest)
    {
        ...
        GetListResponse<GetListOperationClaimListResponseDto> result =
            await Mediator.Send(getListOperationClaimQuery);
    ...
    {
        CreatedOperationClaimResponse result =
            await Mediator.Send(createOperationClaimCommand);
    ...
    {
        UpdatedOperationClaimResponse result =
    ...
    {
        DeletedOperationClaimResponse result =
