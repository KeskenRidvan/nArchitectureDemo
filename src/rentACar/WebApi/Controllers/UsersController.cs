...
public class UsersController : BaseController
{
    ...
    public async Task<IActionResult> GetFromAuth()
    {
        ...
        GetByIdUserResponse result =
            await Mediator.Send(getByIdUserQuery);
    ...
    public async Task<IActionResult> GetList([FromQuery] PageRequest pageRequest)
    {
        ...
        GetListResponse<GetListUserListResponseDto> result =
            await Mediator.Send(getListUserQuery);
    ...
    public async Task<IActionResult> UpdateFromAuth([FromBody] UpdateUserFromAuthCommand updateUserFromAuthCommand)
    {
        ...
        UpdatedUserFromAuthResponse result =
            await Mediator.Send(updateUserFromAuthCommand);
