...
public class AuthManager : IAuthService
{
    ...
    {
        Core.Security.Entities.RefreshToken<int, int> newCoreRefreshToken = _tokenHelper.CreateRefreshToken(
             user,
             ipAddress);
    ...
    {
        Core.Security.Entities.RefreshToken<int, int> coreRefreshToken = _tokenHelper.CreateRefreshToken(
            user,
            ipAddress);
