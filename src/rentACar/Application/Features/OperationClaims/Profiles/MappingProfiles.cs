...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<OperationClaim, GetListOperationClaimListResponseDto>().ReverseMap();
        CreateMap<Paginate<OperationClaim>, GetListResponse<GetListOperationClaimListResponseDto>>().ReverseMap();
    }
}