...
public class GetListUserOperationClaimQuery : IRequest<GetListResponse<GetListUserOperationClaimListResponseDto>>, ISecuredRequest
{
    ...
    public class GetListUserOperationClaimQueryHandler
        : IRequestHandler<GetListUserOperationClaimQuery, GetListResponse<GetListUserOperationClaimListResponseDto>>
    {
        ...
        public async Task<GetListResponse<GetListUserOperationClaimListResponseDto>> Handle(
            GetListUserOperationClaimQuery request,
            CancellationToken cancellationToken)
        {
            Paginate<UserOperationClaim> userOperationClaims =
                await _userOperationClaimRepository.GetListAsync(
                    index: request.PageRequest.PageIndex,
                    size: request.PageRequest.PageSize,
                    enableTracking: false);

            GetListResponse<GetListUserOperationClaimListResponseDto> mappedUserOperationClaimListModel =
                _mapper.Map<GetListResponse<GetListUserOperationClaimListResponseDto>>(userOperationClaims);
