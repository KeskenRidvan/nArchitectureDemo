...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<UserOperationClaim, GetListUserOperationClaimListResponseDto>().ReverseMap();
        CreateMap<Paginate<UserOperationClaim>, GetListResponse<GetListUserOperationClaimListResponseDto>>().ReverseMap();
    }
}